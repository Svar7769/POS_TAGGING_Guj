...
tagged_corpus1 = TaggedCorpusReader(".","Data/guj_art and culture.txt")
tagged_sentences1 = tagged_corpus1.tagged_sents()
tagged_word1 = tagged_corpus1.tagged_words()

tagged_corpus2 = TaggedCorpusReader(".","Data/guj_art and culture_set2.txt")
tagged_sentences2 = tagged_corpus2.tagged_sents()
tagged_word2 = tagged_corpus2.tagged_words()

tagged_sentences = tagged_sentences1 + tagged_sentences2
tagged_word = tagged_word1 + tagged_word2
