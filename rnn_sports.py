...
tagged_corpus1 = TaggedCorpusReader(".","Data/guj_sports.txt")
tagged_sentences1 = tagged_corpus1.tagged_sents()
tagged_word1 = tagged_corpus1.tagged_words()

tagged_corpus2 = TaggedCorpusReader(".","Data/guj_sports_set3.txt")
tagged_sentences2 = tagged_corpus2.tagged_sents()
tagged_word2 = tagged_corpus2.tagged_words()

tagged_corpus3 = TaggedCorpusReader(".","Data/guj_sports_set4.txt")
tagged_sentences3 = tagged_corpus3.tagged_sents()
tagged_word3 = tagged_corpus3.tagged_words()

tagged_sentences = tagged_sentences1 + tagged_sentences2 + tagged_sentences3
tagged_word = tagged_word1 + tagged_word2 + tagged_word3
...
model.fit(train_sentences_X, to_categorical(train_tags_y, len(tag2index)), batch_size=128, epochs=10, validation_split=0.4)
